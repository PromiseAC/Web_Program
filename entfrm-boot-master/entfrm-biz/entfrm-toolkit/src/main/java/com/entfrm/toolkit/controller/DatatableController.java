 ...
 */
@RestController
@RequestMapping(AppConstants.APP_TOOLKIT + "/datatable")
@AllArgsConstructor
public class DatatableController {
    ...
    @SysLog("新建/配置表")
    @SaCheckPermission(value = {"datatable_add", "datatable_config"}, mode = SaMode.OR)
    ...
    @SysLog("表修改")
    @SaCheckPermission("datatable_edit")
    @PutMapping("/update")
    ...
    @SysLog("预览代码")
    @SaCheckPermission("datatable_view")
     ...
     */
    @SysLog("代码生成到本地")
    @SaCheckPermission("datatable_gen")
    ...
    @SysLog("表删除")
    @SaCheckPermission("datatable_del")
...
//        }
    ...
    @SysLog("物理表删除")
    @SaCheckPermission("datatable_drop")
    @DeleteMapping("/drop")
    @Transactional
