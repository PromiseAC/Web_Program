...
import com.entfrm.toolkit.config.GenConfig;
import com.entfrm.toolkit.entity.Column;
import com.entfrm.toolkit.entity.Table;
import com.entfrm.toolkit.mapper.TableMapper;
...
import com.entfrm.toolkit.util.GenUtil;
import com.entfrm.toolkit.util.VelocityInitializer;
import com.entfrm.toolkit.util.VelocityUtil;
...
import static com.entfrm.toolkit.util.GenUtil.*;
    ...
    public Table getGenTable(String tableName, String tableComment) {
        ...
        if (StrUtil.isBlank(tableName)) {
            ...
            if (table != null) {
                ...
                table.setGenApi("0");
                table.setGenWay("1");
                table.setCreateBy(SecurityUtil.getUserName());
